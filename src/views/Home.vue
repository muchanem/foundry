<template>
  <div class="home col-12 mb-5">
    ...
    <v-row class="col-md-8 mx-auto col-12 mt-5 mb-8">
      <v-card elevation="3" outlined class="mx-auto col-md-5 col-6 my-6 text-center">
...
X,y = f.load_data()
    ...
    <!-- end of row -->
    <v-row class="col-12 px-10">
      <div class="col-12 text-end">
        <h1 class="col-10 mx-auto">and save you valuable time</h1>
      </div>
      <v-row class="mb-5 col-10 mx-auto">
