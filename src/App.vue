<template>
  <v-app id="inspire">
    ...
    <!-- desktop nav bar -->
    <!-- <v-toolbar class="flex-grow-0 d-none d-md-flex">
      ...
      <v-toolbar-items class="d-none d-md-flex" v-for="item in items" :key="item.title" :to="item.to" link>
      ...
      <v-navigation-drawer disable-resize-watcher v-model="drawer" app null class="d-xl-none d-lg-none d-md-none">
        ...
        <v-list dense nav>
          <v-list-item v-for="item in items" :key="item.title">
            <a :href="item.to" class="text-decoration-none">
              <v-list-item-icon class="d-inline">
                <v-icon class="d-inline">{{ item.icon }}</v-icon>
              </v-list-item-icon>
    ...
    <v-app-bar app color="white">
      ...
      <v-toolbar-items class="d-none d-md-flex text-decoration-none indigo--text darken-1 " v-for="item in items"
